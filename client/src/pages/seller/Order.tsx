    ...
    <div className="p-6">
      ...
      <div className="space-y-6">
        {order?.orders?.map((order: any) => (
          <div key={order._id} className="bg-white p-5 rounded-2xl shadow">
            {/* TOP */}
            <div className="flex justify-between items-center border-b pb-4">
              ...
              <div className="text-right">
                <h2 className="font-bold text-xl">₹{order.sellerTotal}</h2>
            ...
            <div className="mt-4">
              <h2 className="font-semibold mb-3">
                Order Status :<span className="ml-2">{order.orderStatus}</span>
              </h2>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  onClick={() =>
                    dispatch(updateOrderStatusAction(order._id, "Pending"))
                  }
                >
                  Pending
                </button>
                <button
                  ...
                  onClick={() =>
                    dispatch(updateOrderStatusAction(order._id, "Complete"))
                  }
                >
                  Complete
                </button>
